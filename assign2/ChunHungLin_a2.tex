...
The mean absolute derivation (MAE) between true value and the estimated value of $\mu^{n}_{s}$
is given by:
\begin{align*}
    \text{MAE} = \frac{\sum_{s}\sum_{N}|\mu^{n}_{s} - \hat{\mu}^{n}_{s}|}{2MN}
\end{align*}
The MAE of $\mu^{n}_{s}$ is 8.574
...
\lstinputlisting[language=Python, caption=Implmentation of problem 2.6.19, 
                 basicstyle=\ttfamily\footnotesize, breaklines=true
                 label={lst:label}]
                 {src/sec2_6/main26.py}
\pagebreak
\lstinputlisting[language=Python, caption=Implmentation of problem 2.7.22, 
