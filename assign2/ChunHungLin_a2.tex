...
\begin{table}
    ...
    \pgfplotstabletypeset[
        ...
        every head row/.style={before row=\toprule,after row=\midrule},
        every last row/.style={after row=\bottomrule},
        % columns/Probability/.style={column name=$p(X_v = i\mid X_{pa(v)}, \beta)$}
...
\begin{table}
    ...
    \pgfplotstabletypeset[
        ...
        every head row/.style={before row=\toprule,after row=\midrule},
        every last row/.style={after row=\bottomrule},
        ]{src/sec2_6/est_mu_pair_1_2.csv}
...
\begin{table}
    ...
    \pgfplotstabletypeset[
        ...
        every head row/.style={before row=\toprule,after row=\midrule},
        every last row/.style={after row=\bottomrule},
        ]{src/sec2_6/true_mu_pair_1_2.csv}
...
\begin{align*}
    p(X, Z, C, \pi, \Theta) \approx q(Z, C, \pi, \Theta)\exp[\mathcal{L}(q)]
\end{align*}
