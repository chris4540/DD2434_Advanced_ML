...
\begin{align*}
    \log \tilde{A}^k_{Z^n_{m}Z^n_{m+1}} &= \mathbb{E}_{q(A)}[\log A^k_{Z^n_{m}Z^n_{m+1}}] \\
    &= \sum_{i,j}\mathbb{I}(Z^n_{m} = i, Z^n_{m+1}=j)\mathbb{E}_{q(A)}[\log A^k_{i,j}] \\
    &= \sum_{i,j}\mathbb{I}(Z^n_{m} = i, Z^n_{m+1}=j)
    (\phi(\tilde{\alpha_{A}}^k_{i,j}) -\phi(\sum_{l=1}^{R}\tilde{\alpha_{A}}^k_{i,l})) \\
    &= \phi(\tilde{\alpha_{A}}^k_{Z^n_{m},Z^n_{m+1}}) -\phi(\sum_{l=1}^{R}\tilde{\alpha_{A}}^k_{Z^n_{m},l}) \\
    \tilde{A}^k_{Z^n_{m}Z^n_{m+1}} &= 
