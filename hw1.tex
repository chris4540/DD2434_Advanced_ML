...
\begin{equation} \label{eq:q5-mean}
  \begin{aligned}[b]
    ...
    \frac{\bm{\Sigma}_{p0}}{\sigma^2}(\mathbf{X}\otimes\mathbf{I}_D)\textbf{vec}(\textbf{T}) \\
    \textbf{vec}(\textbf{W}_{p0})) =&
    \frac{1}{\sigma^2}[\frac{1}{\sigma^2}(\mathbf{X}\mathbf{X}^T)\otimes \mathbf{I}_D +\frac{1}{\tau^2}\mathbf{I}_{Dq}]^{-1}
    (\mathbf{X}\otimes\mathbf{I}_D)\textbf{vec}(\textbf{T}) \\
    \textbf{vec}(\textbf{W}_{p0})) =&
    \frac{1}{\sigma^2}([\frac{1}{\sigma^2}(\mathbf{X}\mathbf{X}^T) +\frac{1}{\tau^2}\mathbf{I}_{q}]^{-1}
    \mathbf{X}\otimes\mathbf{I}_D)\textbf{vec}(\textbf{T}) \\
  \end{aligned}
\end{equation}
