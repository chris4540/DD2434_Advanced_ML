...
\begin{align*}
  \hat{\mathbf{W}} 
  &= \operatorname{argmax}_{\mathbf{W}}  p(\mathbf{Y}\mid\mathbf{X}, \mathbf{W}) \\
  &= \operatorname{argmax}_{\mathbf{W}}[-\frac{1}{2\sigma^2}]
\end{align*}
...
The last two expression of Eq. 25 are equivalent. It is because the dominator:
  ...
  \end{align*}
is not a function of $\mathbf{W}$. And we know that the integral gives a possitive real number.
