...
If we consider the noise as a random variable, then the sum
(or the average) of noise will be a random variable following a normal distribution 
by the central limit theorem. Therefore, we can consider the shared noise across 
all sample as a random variable following a normal distribution.
