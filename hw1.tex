...
\begin{question}{21}
First, the spherical Gaussian prior implies that each components of the weighting
vector $\bm{\theta}$ is indepenent.

Second, large variance of the weighting factor allows sampling a weighting vector
with large L2-norm. In the sense of SVM, the margin of the sparation plain is 
