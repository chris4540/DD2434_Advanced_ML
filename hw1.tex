...
\end{align*}
For the sake of convenience, we define $(\mathbf{C}^{-1})^T = \mathbf{C}^{-T}$.\\
...
\begin{align*}
  ...
  &= -\frac{N}{2}[\sum_{k,l} (\mathbf{C}^{-T}\mathbf{S}^{T}\mathbf{C}^{-T})_{kl}
                            (W_{lj}\delta_{ik} + W_{kj}\delta_{il}) ]\\
  &= -\frac{N}{2}[\sum_{l} (\mathbf{C}^{-T}\mathbf{S}^{T}\mathbf{C}^{-T})_{il}W_{lj}
                + \sum_{k} (\mathbf{C}^{-T}\mathbf{S}^{T}\mathbf{C}^{-T})_{ki}W_{kj}] \\
  &= -\frac{N}{2}[\sum_{l} (\mathbf{C}^{-T}\mathbf{S}^{T}\mathbf{C}^{-T})_{il}W_{lj}
                + \sum_{k} (\mathbf{C}^{-T}\mathbf{S}^{T}\mathbf{C}^{-T})_{ik}W_{kj}] \\
