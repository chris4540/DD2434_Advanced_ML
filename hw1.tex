...
\begin{question}{22}
  ...
  \begin{figure}[!ht]
    \subfloat[Plot evident against all data sets, $\mathcal{D}$\label{subfig-1:dummy}]{%
      \includegraphics[width=0.45\textwidth]{fig/Q22-all.png}
    }
    \hfill
    \subfloat[Plot evident against possible data sets, $\mathcal{D}$\label{subfig-2:dummy}]{%
